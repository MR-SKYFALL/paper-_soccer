...
<body>
    ...
    if (check_is_session($connect, $_SESSION['id'])) {
        echo "<div class='alert spiderman-alert'><h1 style='text-align: center; font-size: 32px;' class='spiderman-h'>Podany użytkownik jest już zalogowany i uczestniczy w grze.</h1>";
        echo "<img class='spiderman-img' src='assets/img/spider_man.jpg'>";
        echo "<a href='multi.php' class='button alert spiderman-a' style='padding:10px;text-transform: uppercase;'>Go back</div>";
        exit;
    }
